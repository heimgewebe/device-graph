...
validate: validate-roles validate-assignments validate-networks validate-devices validate-relations validate-relation-targets validate-assignment-targets validate-architecture
